...
lowestF1 = hertzToErb(652.021715922636) ; bErry ; startF1
highestF2 = hertzToErb(1961.3967491237613) ; bErry 

highestF1 = hertzToErb(989.6470618698778) ; bArry
lowestF2 = hertzToErb(1702.6968452111116) ; bArry
...
tg = Read from file: "C:\Users\monik\OneDrive - Univerzita Karlova\tidyDt\exp_final\snd\berry\s1\berryHen2_s1_eq.TextGrid"
...
; formant settings 
formant.ceiling = 5000 ; for female vocal tracts
n.formants = 5 ; works best for my recording

; read original input recording
orig = Read from file: "C:\Users\monik\OneDrive - Univerzita Karlova\tidyDt\exp_final\snd\berry\s1\berryHen2_s1_eq.wav"
...
formGrid2 = Read from file: "C:\Users\monik\OneDrive - Univerzita Karlova\tidyDt\exp_final\snd\berry\s1\man_berryHen2_s1.FormantGrid"
...
manTime1 = ((t2 - t1) / 4) + t1 ; half of the interval 
manTime2 = 3*((t2 - t1) / 4) + t1 ; half of the interval 
